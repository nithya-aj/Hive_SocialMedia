  ...
  return (
    ...
    >
      ...
      <Box sx={{ display: "flex", flexDirection: "column", gap: 1 }}>
        ...
        <FlexCenter>
          <Divider
            sx={{ height: "1px", width: "100%", backgroundColor: main }}
          />
        </FlexCenter>
      </Box>
          ...
          >
            ...
            >
              ...
              <Typography variant="caption" noWrap sx={{ color: medium }}>
                Can you please share your latest work on react, I want to check
                something...
              </Typography>
            </Box>
          </Box>
