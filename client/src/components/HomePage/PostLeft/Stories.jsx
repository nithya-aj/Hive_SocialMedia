    ...
    >
        ...
        >
          ...
          <Avatar
            sx={{
              height: "2rem",
              width: "2rem",
              backgroundColor: { sm: alt, xs: darkbg },
              color: textMain,
            }}
          >
            <HiPlus />
      ...
      <StyledBox
        ...
        sx={{
          minWidth: { xs: 85, lg: 90 },
          cursor: "pointer",
          backgroundImage: "url(https://source.unsplash.com/featured/300x2011)",
        }}
      >
        <Avatar
          sx={{
      ...
      <StyledBox
        ...
        sx={{
          minWidth: { xs: 85, lg: 90 },
          cursor: "pointer",
          backgroundImage: "url(https://source.unsplash.com/featured/300x210)",
        }}
      >
        <Avatar
          sx={{
      ...
      <StyledBox
        ...
        sx={{
          minWidth: { xs: 85, lg: 90 },
          cursor: "pointer",
          backgroundImage: "url(https://source.unsplash.com/featured/300x205)",
        }}
      >
        <Avatar
          sx={{
      ...
      <StyledBox
        ...
        sx={{
          minWidth: { xs: 85, lg: 90 },
          cursor: "pointer",
          backgroundImage: "url(https://source.unsplash.com/featured/300x203)",
        }}
      >
        <Avatar
          sx={{
      ...
      <StyledBox
        ...
        sx={{
          minWidth: { xs: 85, lg: 90 },
          cursor: "pointer",
          backgroundImage: "url(https://source.unsplash.com/featured/300x208)",
        }}
      >
        <Avatar
          sx={{
      ...
      <StyledBox
        ...
        sx={{
          minWidth: { xs: 85, lg: 90 },
          cursor: "pointer",
          backgroundImage: "url(https://source.unsplash.com/featured/300x243)",
        }}
      >
        <Avatar
          sx={{
      ...
      <StyledBox
        ...
        sx={{
          minWidth: { xs: 85, lg: 90 },
          cursor: "pointer",
          backgroundImage: "url(https://source.unsplash.com/featured/300x204)",
        }}
      >
        <Avatar
          sx={{
      ...
      <StyledBox
        ...
        sx={{
          minWidth: { xs: 85, lg: 90 },
          cursor: "pointer",
          backgroundImage: "url(https://source.unsplash.com/featured/300x209)",
        }}
      >
        <Avatar
          sx={{
