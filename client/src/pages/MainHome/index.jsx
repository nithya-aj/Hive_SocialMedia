      ...
      <Grid container sx={{ flexGrow: 1 }} backgroundColor={main}>
        {isMessagesRoute || isSettingsRoute ? (
          <>
            ...
            <Grid item lg={10} md={9.5} sm={9.5} xs={12} sx={{ pt: '1rem' }}>
              <Box sx={{ borderRadius: { sm: '10px 10px 0px 0px', md: '10px 0px 0px 10px' }, height: '90vh', overflow: 'auto', backgroundColor: { sm: alt, xs: main }, border: { sm: `2px solid ${alt}`, xs: `2px solid ${main}` } }}>
                <Outlet />
              </Box>
            </Grid>
          </>
